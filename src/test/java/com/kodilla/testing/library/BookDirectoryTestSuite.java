...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf0() {
        ...
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "90011604684");
        List<Book> resultListOfBooksInHandsOf0 = generateListOfNBooks(0);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser))
                .thenReturn(resultListOfBooksInHandsOf0);
        // When
    ...
    public void testListBooksInHandsOf1() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "90011604684");
        List<Book> resultListOfBooksInHandsOf1 = generateListOfNBooks(1);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser))
                .thenReturn(resultListOfBooksInHandsOf1);
        // When
    ...
    public void testListBooksInHandsOf5() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("John", "Smith", "90011604684");
        List<Book> resultListOfBooksInHandsOf5 = generateListOfNBooks(5);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser))
                .thenReturn(resultListOfBooksInHandsOf5);
        // When
